            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align:center">
                      ...
                      <button class="btn btn-primary" onclick="location.href='/IMK-Kelompok-6/views/perpanjang_peminjaman.php'" type="button">Perpanjang</button>
                      <button class="btn btn-primary" onclick="location.href='/IMK-Kelompok-6/views/pengembalian.php'" type="button">Kembalikan</button>
                    </td>
                </tr>
                <tr>
                  ...
                  <td style="text-align:center">Rp.85.000,00</td>
                    ...
                    <td style="text-align:center">
                      <div class="d-grid gap-3 col-8 mx-auto">
                      <button class="btn btn-primary" onclick="location.href='/IMK-Kelompok-6/views/sedang_menyewa.php'" type="button">Perpanjang</button>
                      <button class="btn btn-primary" onclick="location.href='/IMK-Kelompok-6/views/sedang_menyewa.php'" type="button">Kembalikan</button>
                    </td>
                </tr>
                <tr>
