          ...
          <div class="row justify-content-center py-5">
              ...
              <div class="card">
                  ...
                  <div class="d-grid gap-3 col-8 mx-auto">
                    <button class="btn btn-primary" onclick="location.href='/IMK-Kelompok-6/index.php'" type="button">Login</button>
                    <button class="btn btn-outline-primary" onclick="location.href='/IMK-Kelompok-6/views/signup.php'" type="button">Sign Up</button>
                  </div>
                  <p> </p>
